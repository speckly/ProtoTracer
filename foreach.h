 ...
 * File: foreach.h
 * ---------------
 * This interface defines the foreach keyword, which implements a
 * substitute for the range-based for loop from C++11.  All iterable
 * classes in the Stanford libraries import this interface, so clients
 * don't ordinarily need to do so explicitly.  This version of the
 * interface also supports C++ strings and arrays.
 */
